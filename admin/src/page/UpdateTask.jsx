...
export default function UpdateTask() {
    ...
    const fetchTask = async () => {
        ...
        const res = await axios.get(url + `/api/task/get-task/${taskId}`)
    ...
    const handleSubmit = async (e) => {
        ...
        try
        {
            ...
            const res = await axios.put(url + `/api/task/update-task/${taskId}`,formData,{headers:{token}})

            if(res.data.success)
            {
                toast.success(`${res.data.updatedTask.title} is updated successfully`)
  ...
  return (
    ...
    <>
        ...
        {!fetchingTaskError && !fetchingTaskLoading && (
