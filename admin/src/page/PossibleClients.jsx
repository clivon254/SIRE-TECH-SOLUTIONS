...
export default function PossibleClients() {
  ...
  useEffect(() => {
    ...
    if(location.pathname === '/possible-clients')
    {
      setClientQuery(false)
                  ...
                  (
                     <Table.Body>
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell colSpan={5} className="text-center text-xl">The are no Poscible Clients yet</Table.Cell>
